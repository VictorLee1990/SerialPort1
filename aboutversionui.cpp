    ...
    ui(new Ui::AboutVersionUI)
{
    ...
    ui->tableWidget_VersionTable->setRowCount(2);     //設定QTableWidget列數
...
//    ui->tableWidget_VersionTable->setRowCount(1);     //設定QTableWidget列數
    ui->tableWidget_VersionTable->setItem(1,0,new QTableWidgetItem(Version_str));
    ui->tableWidget_VersionTable->setItem(1,1,new QTableWidgetItem(VersionDate_str));
